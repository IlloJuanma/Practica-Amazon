...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION["usuario"])) {
        ...
        if ($resultadoProductoExistente->num_rows > 0) {
            ...
            // Si el producto no está en la cesta, inserta un nuevo registro
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark">
                <div class="container-fluid">
                    <a class="navbar-brand titulo_nav" href="#"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu bg-dark-subtle">
                                    <li><a class="dropdown-item" href="https://www.instagram.com/juanma_rodrguez/"><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                class="icon icon-tabler icon-tabler-brand-instagram" width="32"
                                                height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000"
                                    ...
                                    <li><a class="dropdown-item" href="https://twitter.com/MrFlexaverde"><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                class="icon icon-tabler icon-tabler-brand-x" width="32" height="32"
                                    ...
                                    <li><a class="dropdown-item" href="https://github.com/IlloJuanma"><svg
                                                xmlns="http://www.w3.org/2000/svg"
